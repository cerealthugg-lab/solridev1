...
const Section = ({ icon: Icon, eyebrow, title, accent, children }) => (
  ...
  >
    <div className="flex items-start gap-4">
      <div
        className="flex h-11 w-11 shrink-0 items-center justify-center border border-zinc-800"
      ...
      <div className="flex-1">
        ...
        <h3 className="mt-1.5 text-2xl text-white font-black uppercase tracking-tight leading-tight">
          {title}
        </h3>
...
const Welcome = () => {
  ...
  // also let logged-in users skip if they already have a token
  useEffect(() => {
  ...
  return (
    <div
      ...
      className="bg-[#09090b] min-h-screen text-[#EDEDED] font-sans selection:bg-[#D2FF00] selection:text-black max-w-md mx-auto relative shadow-2xl shadow-black overflow-hidden border-x border-zinc-900"
    >
      {/* Top gradient bar — matches your Layout */}
      ...
      <button
        ...
        className="absolute top-4 right-4 z-40 text-[10px] tracking-[0.2em] uppercase text-zinc-500 hover:text-white font-bold"
      >
        Skip →
      </button>

      <main className="px-6 pt-14 pb-10">
        {/* Hero — italic black gradient SOLRIDE */}
        <section
        ...
        >
          <h1
            ...
            className="text-7xl font-black italic tracking-tighter mb-3 bg-gradient-to-br from-[#D2FF00] to-[#ffffff] bg-clip-text text-transparent leading-none"
          >
            SOLRIDE
          </h1>
          <p className="text-zinc-500 uppercase tracking-[0.25em] text-[11px] font-bold">
            Ride. Track. Earn.
          </p>
        </section>
        ...
        >
          <button
            ...
            onClick={() => goAuth("login")}
            className="w-full bg-[#D2FF00] text-black hover:bg-[#c2eb00] font-black uppercase tracking-widest rounded-none h-14 text-base flex items-center justify-center gap-3 transition-colors"
          >
            Login
          ...
          <button
            ...
            className="w-full bg-zinc-900 text-white hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-700 font-black uppercase tracking-widest rounded-none h-14 text-base flex items-center justify-center gap-3 transition-colors"
          >
            Create Account
            <ArrowRight size={18} strokeWidth={3} />
          </button>
      ...
      <footer
        ...
        className="px-6 pb-10 pt-6 text-center"
      >
